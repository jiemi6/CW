<?php
	...
	if($this->type==80){//巴西3.5分彩
		$logcls = "icon_bx35";
	}
	if($this->type==75){//巴西快乐彩
		$logcls = "icon_bxklc";
	}	
	if($this->type==81){//广东快乐10
		$logcls = "icon_gdkll0";
	}
	if($this->type==9){//福彩3D
		$logcls = "icon_fc_3d";
	...
	if($this->type==82){//广东快乐10分彩
		$logcls = "icon_gdkll0";
	}	
	
	
	if($this->type==83){//腾讯分分彩
		$logcls = "icon_ffc_1t";
	}			
	
	if($this->type==84){//加纳分分彩
		$logcls = "icon_ffc_1j";
	}			
	
	if($this->type==85){//1.5分彩
		$logcls = "icon_ffc_1d5";
	}			
	
	if($this->type==86){//3.5分彩
		$logcls = "icon_ffc_3d5";
	}	
