	...
	<div class="sidebar_con">
		<div class="sidebar_gamebox">
			<ul>
				...
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/83/2/12/腾讯分分彩">腾讯分分彩</a></span><i class="icon_new"></i></li>
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/84/2/12/加纳分分彩">加纳分分彩</a></span><i class="icon_new"></i></li>
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/85/2/12/韩国1.5分彩">韩国1.5分彩</a></span><i class="icon_new"></i></li>
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/86/2/12/加拿大3.5分彩">加拿大3.5分彩</a></span><i class="icon_new"></i></li>
				<li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/87/2/12/台湾5分彩">台湾5分彩</a></span><i class="icon_new"></i></li>
                <li class="sidebar_gamebox_bg"><span class="lname"><a href="/index.php/index/game/6/广东11选5">广东11选5</a></span><i class="icon_new"></i></li>
...
<!--			<dl class="jn">
		...
		<div class="sidebar_othergames">
			<div class="sidebar_header_title"><a href="/" target="_blank">财缘娱乐彩票</a></div>
		</div>
	...
	<div class="warp980">
		...
		<div class="same_box phone_box">
			<div class="left">
	    		<h3>安卓APP</h3>
	    		<p>下载地址：</p>
	    		<a href="/cs.html" class="icon-Android" target="_blank">
	    			Android
	    		</a>
    		</div>
    		<div class="img">
		...
		<div class="same_box pt_box">
			<div class="left">
			    <h3>苹果ISO</h3>
			    <p>下载地址：</p>
	    		<a href="/cs.html" class="icon-iPhone" target="_blank">
	    			iPhone
	    		</a>
		    </div>
		    <div class="img">
...
<div class="login_footer">
	<div class="warp980">
		...
		<div class="clearfix">
			...
			<p class="t-right">
				未满18周岁禁止购买<br />
				Copyright © SinCai 2010-2016  财缘娱乐 版权所有
			</p>
		</div>
	</div>
</div>
...
<script type="text/javascript">
    ...
    so.addVariable("appurl", "#"); // 在这里修改财缘娱乐AIR客户端下载地址，air名称Main可以随意修改
