...
class xingcai extends WebBase{
	...
	public final function ffc_1t(){
		$this->display('xingcai/ffc_1t.php');
	}
	...
	public final function xcbx3(){
		$this->display('xingcai/bx3.php');
	}	
	public final function xcbx35(){
		$this->display('xingcai/bx35.php');
	}		
